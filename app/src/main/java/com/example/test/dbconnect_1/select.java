...
public class select extends AppCompatActivity {
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(select.this,
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://211.236.54.253/select.php";
    ...
    private void showResult(){
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(select.this, mArrayList, R.layout.item_list, new String[]{TAG_ID,TAG_NAME, TAG_ADDRESS},
